...
public class StaticField implements Serializable{
	...
	public StaticField(String name, String type, int modifiers, String declaration) {
		this.name = name;
		this.type = type;
	...
	public String getSubSignature() {return type + " " + name;}
	
	public String getFullSignature() {return declaringClass.getName() + ": " + getSubSignature();}
