...
public class StaticStmt implements Serializable{
	...
	public StaticStmt(String stmt, boolean hasInvokeExpr, boolean hasFieldRef, String targetClass, String targetSubSig) {	
	...
	public String getJimpleStmt() {	return jimpleCode;}

	public boolean containsMethodCall() {return containsMethodCall;}
	
	public boolean containsFieldRef()	{return containsFieldRef;}
	
	public StaticMethod getResidingMethod() {	return familyMethod;	}
	...
	public String getTargetSubSig() {	return targetSubSig;}
